...
tspan = [0, 10]
w[0] = 1
sol1 = scipy.integrate.solve_ivp(exampleNet.ODEfunc, tspan, y0, args=(tau, ymax, w, n, EC50,))
w[0] = 0
sol2 = scipy.integrate.solve_ivp(exampleNet.ODEfunc, tspan, sol1.y[:, -1], args=(tau, ymax, w, n, EC50,))
w[1] = 1
sol3 = scipy.integrate.solve_ivp(exampleNet.ODEfunc, tspan, sol2.y[:, -1], args=(tau, ymax, w, n, EC50,))
w[1] = 0
sol4 = scipy.integrate.solve_ivp(exampleNet.ODEfunc, tspan, sol3.y[:, -1], args=(tau, ymax, w, n, EC50,))
w[0] = 1
w[1] = 1
sol5 = scipy.integrate.solve_ivp(exampleNet.ODEfunc, tspan, sol4.y[:, -1], args=(tau, ymax, w, n, EC50,))
